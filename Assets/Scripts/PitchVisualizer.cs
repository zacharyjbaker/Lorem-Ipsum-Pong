...
public class PitchVisualizer : PlayerPaddle
{
    ...
    string GetNameFromFrequency(float frequency)
    {
        ...
        //MoveFromNote(names[noteNumber % 12]);
        MoveFromFreq(frequency);
        return names[noteNumber % 12];
    }

    /*
    void MoveFromNote(string note) 
    {
        if (note == "E")
        {
